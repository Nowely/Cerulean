...
/// <summary>
/// Represents the types of operators that can be used for filtering dates.
/// </summary>
[JsonConverter(typeof(JsonStringOrNumberEnumConverter<DateOperatorType>))]
public enum DateOperatorType {
	/// <summary>
	/// Represents the operator for checking if a date value is equal to a specific value.
	/// </summary>
	Is,

	/// <summary>
	/// Represents the 'IsBefore' date operator type.
	/// </summary>
	IsBefore,

	/// <summary>
	/// Represents a date operator type that filters dates that are after a specified value.
	/// </summary>
	IsAfter,

	/// <summary>
	/// Represents the operator type for filtering dates that are on or before a specific date.
	/// </summary>
	IsOnOrBefore,

	/// <summary>
	/// Represents the "Is On Or After" operator for filtering dates.
	/// </summary>
	IsOnOrAfter,

	/// <summary>
	/// Represents the operator for checking if a date value is between a range of dates.
	/// </summary>
	IsBetween,

	/// <summary>
	/// Represents the operator that filters dates based on their relationship with today's date.
	/// </summary>
	IsRelativeToToday, //Past, Next value > 0, This (day, week, month, year)

	/// <summary>
	/// Represents an operator to check if a date property is empty.
	/// </summary>
	IsEmpty,

	/// <summary>
	/// Represents a date operator that checks if a date value is not empty.
	/// </summary>
	IsNotEmpty
}
